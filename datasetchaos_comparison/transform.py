...
class RandomHorizontallyFlip(object):
    def __call__(self, img1, img2, augset, mask):
        if random.random() < 0.5:
            ...
            augset['mask1'] = augset['mask1'].transpose(Image.FLIP_LEFT_RIGHT)
            augset['hflip1'] = 1
        if random.random() < 0.5:
            ...
            augset['mask2'] = augset['mask2'].transpose(Image.FLIP_LEFT_RIGHT)
            augset['hflip2'] = 1
        if random.random() < 0.5:
            ...
            augset['mask3'] = augset['mask3'].transpose(Image.FLIP_LEFT_RIGHT)
            augset['hflip3'] = 1
        if random.random() < 0.5:
            ...
            augset['mask4'] = augset['mask4'].transpose(Image.FLIP_LEFT_RIGHT)
            augset['hflip4'] = 1
        return img1, img2, augset, mask
...
class RandomRotate(object):
    ...
    def __call__(self, img1, img2, augset, mask):
        ...
        augset['mask1'] = augset['mask1'].rotate(rotate_degree, Image.NEAREST)
        ...
        augset['mask2'] = augset['mask2'].rotate(rotate_degree, Image.NEAREST)
        ...
        augset['mask3'] = augset['mask3'].rotate(rotate_degree, Image.NEAREST)
        ...
        augset['mask4'] = augset['mask4'].rotate(rotate_degree, Image.NEAREST)
