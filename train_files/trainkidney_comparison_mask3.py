...
def parse_args():
    ...
    parser.add_argument('--maskidentity', default=3, type=int, help='...')
    ...
    parser.add_argument('--checkpoint', default='checkpoint_kidney_comparisonmask3/')
    parser.add_argument('--history', default='history_kidney_comparisonmask3')
