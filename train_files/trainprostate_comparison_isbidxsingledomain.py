...
def parse_args():
    ...
    parser.add_argument('--checkpoint', default='checkpoint_prostatedx_comparisonsingledomain/')
    parser.add_argument('--history', default='history_prostatedx_comparisonsingledomain')
...
if __name__ == "__main__":
    ...
    train_csv = '../../inputs_prostatemr/Prostate_split2D/ISBI2013_nrrd/prostatedx_train.csv'
    test_root = '../../inputs_prostatemr/ISBI2013_nrrd_labelcombine/testall'
    test_csv = '../../inputs_prostatemr/Prostate_split2D/ISBI2013_nrrd/prostatedx_testall.csv'
    traincase_csv = '../../inputs_prostatemr/Prostate_split2D/ISBI2013_nrrd/prostatedx_casetrain.csv'
    testcase_csv = '../../inputs_prostatemr/Prostate_split2D/ISBI2013_nrrd/prostatedx_casetestall.csv'
