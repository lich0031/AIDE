...
if __name__ == "__main__":
    ...
    train_csv = '../../inputs_prostatemr/Prostate_split2D_crossdomain/ISBI2013_nrrd_combineall/traindxgenerate3t_train.csv'
    test_csv = '../../inputs_prostatemr/Prostate_split2D_crossdomain/ISBI2013_nrrd_combineall/traindxgenerate3t_testall.csv'
    traincase_csv = '../../inputs_prostatemr/Prostate_split2D_crossdomain/ISBI2013_nrrd_combineall/traindxgenerate3t_casetrain.csv'
    testcase_csv = '../../inputs_prostatemr/Prostate_split2D_crossdomain/ISBI2013_nrrd_combineall/traindxgenerate3t_casetestall.csv'
    labeledcase_csv = '../../inputs_prostatemr/Prostate_split2D_crossdomain/ISBI2013_nrrd_combineall/traindxgenerate3t_labeledcasetrain.csv'
    tempmaskfolder = 'generated_masks_traindxgenerate3t'
    makefolder(os.path.join(train_root, tempmaskfolder))
    tempmaskfolder = 'generated_masks_traindxgenerate3t/{}_{}'.format(args.model_name, args.repetition)
