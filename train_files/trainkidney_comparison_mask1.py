...
def parse_args():
    ...
    parser.add_argument('--maskidentity', default=1, type=int, help='...')
    ...
    parser.add_argument('--checkpoint', default='checkpoint_kidney_comparisonmask1/')
    parser.add_argument('--history', default='history_kidney_comparisonmask1')
