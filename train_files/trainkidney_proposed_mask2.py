...
def parse_args():
    ...
    parser.add_argument('--resumefile', default='initializemodel/UNet_besttraindice_Task1Mask2.pkl')
    parser.add_argument('--checkpoint', default='checkpoint_kidney_proposedmask2')
    parser.add_argument('--history', default='history_kidney_proposedmask2')
    parser.add_argument('--maskidentity', default=2, type=int)
