...
from datasets import breast_seg, Compose, Resize, RandomRotate, RandomHorizontallyFlip, ToTensor, Normalize
from models_singlemodal import UNet
...
def parse_args():
    ...
    parser.add_argument('--checkpoint', default='checkpoint_breastdata3_comparison25labels/')
    parser.add_argument('--history', default='history_breastdata3_comparison25labels')
...
def Train(train_root, train_csv, test_csv):
    ...
    for epoch in range(start_epoch, end_epoch):
        ...
        for batch_idx, (imgs, _, targets) in tqdm(enumerate(train_loader),
        ...
        test_dice = 0.
        test_count = 0
        for batch_idx, (imgs, _, targets) in tqdm(enumerate(test_loader),
...
if __name__ == "__main__":
    ...
    train_csv = '../../inputs_breastMR_Henan_372cases/BreastMR_csvfiles/splitcleanlabels/train_data_25cases_imgs.csv'
