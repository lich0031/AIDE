...
if __name__ == "__main__":
    ...
    train_csv = '../inputs_chaos/All_Sets_split/splitimages_cleanlabel/train_data_1cases.csv'
    test_csv = '../inputs_chaos/All_Sets_split/splitimages_cleanlabel/val_data_10cases.csv'
    traincase_csv = '../inputs_chaos/All_Sets_split/splitcases/train_data_1cases.csv'
